...
# --- Sidebar ---
st.sidebar.title("🌍 AirLens Filters")
st.sidebar.markdown("Filter the dashboard to focus on specific regions or years.")
...
st.sidebar.markdown("AirLens is an AQI monitoring and analytics dashboard powered by Streamlit, Pandas, and Matplotlib.")

# --- Filter Data ---
filtered_df = get_filtered_data(df, selected_country, selected_year)

# --- Main Dashboard ---
st.title("AirLens: AQI Monitoring & Analytics Dashboard")
st.markdown("Analyze air quality indices, pollutant trends, and environmental conditions.")
...
with col1:
    st.metric(label="Average AQI Level", value=f"{avg_aqi:.1f}")
with col2:
